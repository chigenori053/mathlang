...
- OPS-01: 文書同期ツール
- OPS-02: CI監視フロー（pytest + CLI/Notebook self-test）整備
...
### サマリー
- Python 3.12 / 3.14 で 51 件の pytest が成功。CLI/Evaluator/Fuzzy/Fraction/Polynomial/Symbolic/CausalEngine まで網羅。
